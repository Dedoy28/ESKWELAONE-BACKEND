...
class SectionHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'school_year', 'section', 'is_active']
...
# ==========================================================
# UPDATED SimpleStudentSerializer
# ==========================================================
class SimpleStudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'current_grade', 'current_section_name',
        ]
...
class AttendanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["updated_at", "created_at", "day_of_week", "student_display"]
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    section_history = SectionHistorySerializer(
    ...
    class Meta:
        model = Student
        fields = [
            "id", "lrn", "first_name", "last_name", "middle_name", "name_extension",
            "section_id", "school_year",
            "current_enrollment", "section_history",
            "grade", "section", "adviser_name",
    ...
    def get_current_enrollment(self, obj):
        ...
        if enrollment:
            return {
                ...
                'section': SectionSerializer(enrollment.section).data,
...
class ClinicVisitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ClinicVisit
        fields = "__all__" 
        read_only_fields = ["id", "created_at", "updated_at", "student", "grade", "section_name", "visit_date"]
...
class BehaviorRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = "__all__"
        read_only_fields = ["id", "created_at", "updated_at", "student", "grade", "section_name", "date"]

# ====================================================================
# ⭐️ UPDATED StudentSf10Serializer ⭐️
# ====================================================================
class Sf10GradeSerializer(serializers.ModelSerializer):
    ...
    # ⭐️ NEW: Send Section/Adviser with Grades as Backup ⭐️
    section_name = serializers.CharField(source='teacher_class.section.name', read_only=True)
    adviser_name = serializers.CharField(source='teacher_class.section.adviser_name', read_only=True)
    ...
    class Meta:
        model = Enrollment
        fields = ['subject_name', 'q1', 'q2', 'q3', 'q4', 'final', 'section_name', 'adviser_name']
...
class StudentSf10Serializer(serializers.ModelSerializer):
    ...
    def get_general_average(self, obj):
        if obj.general_average is not None:
            return str(obj.general_average)
        return None
...
class StudentImportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'lrn', 'email', 'phone', 'address', 'birth_date',
            'gender', 'guardian_name', 'guardian_phone', 'guardian_email',
            'emergency_contact', 'medical_notes', 'section_id', 'school_year',
        ]
        extra_kwargs = {
            'lrn': {
                'validators': [
